"""Training NeuralDMD on interferometric (visibility) data.

The loss is a reduced chi-squared on the observed complex visibilities
(per real degree of freedom), plus a negativity penalty on the image and L1
sparsity on the spatial modes and temporal amplitudes. Amplitude and
closure-phase chi-squared are tracked as diagnostics. train_model early-stops
once chi2_vis reaches the noise level (~1).
"""
